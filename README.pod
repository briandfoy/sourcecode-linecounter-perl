...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/SourceCode-LineCounter-Perl> or 
L<MetaCPAN|http://www.metacpan.org/module/SourceCode::LineCounter::Perl>:

=over 4

=item *	L<http://search.cpan.org/dist/SourceCode-LineCounter-Perl>

=item *	L<http://www.metacpan.org/module/SourceCode::LineCounter::Perl>
